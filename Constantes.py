...
ORDEN_NIVELES = [
    MAPAS_PATH + "zona_1.tmx",      # fondo (1).jpeg
    MAPAS_PATH + "zona_1.1.tmx",    # fondo (1_1).jpeg
    MAPAS_PATH + "zona_1.2.tmx",    # fondo (1_2).jpeg
    MAPAS_PATH + "zona_1.3.tmx",    # fondo (1_3).png
    MAPAS_PATH + "zona_1.4.tmx",    # fondo (1_4).jpeg
    MAPAS_PATH + "zona_2.tmx",      # fondo (2).png
    MAPAS_PATH + "zona_2.1.tmx",    # fondo (2_2).png
    MAPAS_PATH + "zona_2.2.tmx",    # fondo (2_1).png
    MAPAS_PATH + "zona_2.3.tmx",    # fondo (2_3).png
    MAPAS_PATH + "zona_2.4.tmx",    # fondo (2_4).png
    MAPAS_PATH + "zona_2.5.tmx",    # fondo (2_5).png
    MAPAS_PATH + "zona_3.tmx",      # fondo (3).jpeg
]
